...
public class AccordeonTest {
    ...
    public AccordeonTest(String textHeader, String textBody, boolean coincidence) {
    ...
    public void AccordeonTestCheck() {
        ...
        List<WebElement> elements = driver.findElements(By.xpath("//div[starts-with(@id,'accordion__heading')]"));
        for (WebElement element:elements){
            if (element.getText() == textHeader) {
                element.click();
                assertEquals(coincidence,objMainPage.checkTextBodyAccordeon(),textBody);
            }
        }
    }
}
